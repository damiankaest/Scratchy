        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FirebaseId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NfcTagId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ScratchId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    AlbumId = table.Column<int>(type: "int", nullable: true),
                    Title = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Scratches", x => x.ScratchId);
                    table.ForeignKey(
                        name: "FK_Scratches_Albums_AlbumId",
                        column: x => x.AlbumId,
                        principalTable: "Albums",
                        principalColumn: "AlbumId");
                    table.ForeignKey(
                        name: "FK_Scratches_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScratchesTags", x => new { x.ScratchId, x.TagId });
                    table.ForeignKey(
                        name: "FK_ScratchesTags_Scratches_ScratchId",
                        column: x => x.ScratchId,
                        principalTable: "Scratches",
                        principalColumn: "ScratchId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScratchesTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ScratchesScratchId = table.Column<int>(type: "int", nullable: false),
                    TagsTagId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScratchTag", x => new { x.ScratchesScratchId, x.TagsTagId });
                    table.ForeignKey(
                        name: "FK_ScratchTag_Scratches_ScratchesScratchId",
                        column: x => x.ScratchesScratchId,
                        principalTable: "Scratches",
                        principalColumn: "ScratchId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScratchTag_Tags_TagsTagId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Scratches_AlbumId",
                table: "Scratches",
                column: "AlbumId");

            migrationBuilder.CreateIndex(
                name: "IX_Scratches_UserId",
                table: "Scratches",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ScratchesTags_TagId",
                table: "ScratchesTags",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_ScratchTag_TagsTagId",
                table: "ScratchTag",
                column: "TagsTagId");
